...
function getCategories(node, kind) {
    let result = [];
    let children = node.groups && node.groups.filter((x) => (x.kind & kind) !== 0);
...
function grok(src, options) {
    var _a, _b, _c, _d, _e;
    try {
        gSynonyms = (_a = options.keywordSynonyms) !== null && _a !== void 0 ? _a : {};
        gNodes = getReflectionsFromFile(src, options);
        let sdkName = (_b = options.sdkName) !== null && _b !== void 0 ? _b : '';
        const packageName = (_d = (_c = options.sdkName) !== null && _c !== void 0 ? _c : gNodes.name) !== null && _d !== void 0 ? _d : '';
        let content;
        if (options.modules) {
        ...
        if (content) {
            ...
            return { [(_e = options === null || options === void 0 ? void 0 : options.outFile) !== null && _e !== void 0 ? _e : 'index.html']: document };
        }
    }
    catch (err) {
        console.error(err);
